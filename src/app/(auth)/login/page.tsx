      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl items-center justify-center">
        ...
        <div className="auth-card rounded-[2rem] p-8">
          <button
            ...
            className="interactive-card w-full flex items-center justify-center gap-3 rounded-xl border border-[var(--border)] bg-[rgba(255,250,244,0.76)] px-4 py-3 font-medium hover:bg-[var(--surface-hover)]"
          >
